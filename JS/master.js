...
const datosJson = JSON.stringify(listaGuitarras);
...
textoNosotros.append("Somos una empresa especial, trabajamos unicamente con modelos antiguos utilizados por grandes guitarristas en sus mejores momentos. Te invitamos a navegar el espacio virtual y porque no, acercarte fisicamente a nuestra tienda en el centro de la ciudad de Buenos Aires, para poder deisfrutar probando instrumentos de calidad e historia unica en el mundo. No lo dudes, escribinos o acercate, el Marshall te espera encendido. Que sea rock!");
...
const catalogo = document.createElement("button");
catalogo.append("Descargar Catalogo");
catalogo.id = "catalogo";
contenedorPrincipal.appendChild(nuestrosModelos);
contenedorPrincipal.appendChild(catalogo);
...
document.getElementById("catalogo").addEventListener("click", generarJson);